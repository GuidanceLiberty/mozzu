  ...
  return (
    <main className="w-full overflow-x-hidden">
      ...
      <section className="py-20 md:py-32 bg-white overflow-hidden relative">
        {/* LEFT FLOATING IMAGE - Fixed at bottom left */}
        <motion.img
          src={teamDetails.shaeLeft}
          alt="decoration"
          className="absolute left-0 bottom-20 w-48 pointer-events-none z-0"
          animate={{ y: [0, -25, 0] }}
        ...
        <div className="container mx-auto px-4 max-w-[1300px] relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div className="flex flex-col items-center lg:items-start">
              <motion.div
                ...
                className="relative rounded-[40px] overflow-hidden shadow-2xl mb-10 w-full"
              >
                <img
                  src={teamDetails.mainImage}
              ...
              {/* EXPERIENCE TITLE  */}
              <h3 className="text-3xl md:text-4xl font-black text-black tracking-tight text-center lg:text-left">
                {teamDetails.experience}
              </h3>
            </div>
            ...
            >
              ...
              <span className="text-[#ff4d00] text-xl font-bold mb-8 block">
                {teamDetails.role}
              </span>
              ...
              <blockquote className="border-l-4 border-[#ff4d00] pl-6 mb-10">
              ...
              <div className="space-y-6 mb-10">
                <div className="flex items-center gap-5 group">
                  <div className="w-14 h-14 bg-[#F8F8F8] rounded-full flex items-center justify-center text-black group-hover:bg-[#ff4d00] group-hover:text-white transition-all duration-300">
                    <Phone size={22} />
                  </div>
                  <div>
                ...
                <div className="flex gap-4">
                  {[Facebook, Twitter, Youtube, Linkedin].map((Icon, idx) => (
                    <a
                      key={idx}
                      href="#"
                      className="w-12 h-12 border-2 border-gray-100 rounded-full flex items-center justify-center text-gray-400 hover:border-[#ff4d00] hover:text-[#ff4d00] transition-all duration-300"
                    >
                      <Icon size={20} />
                    </a>
                  ))}
          ...
          {/* ================= SPECIAL DISHES SECTION (Left Aligned) ================= */}
          <div className="mt-20 lg:mt-32 max-w-[800px]">
            <h4 className="text-2xl md:text-3xl font-black text-black mb-4">
              {teamDetails.specialDishes.title}
            </h4>
            <p className="text-gray-600 text-lg leading-relaxed mb-10">
              {teamDetails.specialDishes.description}
            </p>

            {/* Dishes Grid - Left aligned with specific image sizing */}
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {teamDetails.specialDishes.items.map((dish, index) => (
                <motion.div
                  key={index}
        ...
        {/* RIGHT FLOATING IMAGE - Top 50px */}
        <motion.img
          src={teamDetails.shaeRight}
          alt="decoration"
          className="absolute right-0 top-[50px] w-56 pointer-events-none z-0"
          animate={{ y: [0, 25, 0] }}
          transition={{
            duration: 5,
            repeat: Infinity,
