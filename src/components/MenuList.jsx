  ...
  return (
    <main className="w-full overflow-x-hidden">
      ...
      <section className="relative w-full h-[450px] md:h-[550px] text-white overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 w-full">
          ...
          >
            ...
            <span className="text-xl">›</span>
            <span className="opacity-80">List layout</span>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative w-full bg-[#f9f9f9] py-24 px-4 overflow-hidden">
        ...
        <motion.img
          src={menuList[18].bigLeftSideImg}
          alt="decoration"
          className="absolute left-[-50px] bottom-10 w-48 lg:w-72 pointer-events-none opacity-90 z-0"
          animate={{ y: [0, -25, 0] }}
          transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.img
          src={menuList[18].bigRightSideImg}
          alt="decoration"
          className="absolute right-[-50px] top-[40%] w-48 lg:w-72 pointer-events-none opacity-90 z-0"
          animate={{ y: [0, 30, 0] }}
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {menuList.slice(0, 18).map((item, idx) => (
              <Link to={`/menu/${idx}`} key={idx}>
                <motion.div
                  ...
                  className="bg-white p-6 rounded-2xl shadow-sm border border-gray-400 flex justify-between items-start group hover:border-[#ff4d24] hover:shadow-md transition-all duration-300 h-full"
                >
                  {/* LEFT: TEXT CONTENT */}
                  <div className="flex-1 pr-4">
                    <h3 className="text-xl font-bold text-[#1a1a1a] mb-2 group-hover:text-[#ff4d24] transition-colors">
                      {item.name}
                    </h3>
                    <p className="text-gray-500 text-sm leading-relaxed mb-4 line-clamp-2">
                      {item.text}
                    </p>
                    <span className="text-[#ff4d24] font-bold text-xl">
                      {item.price}
                    </span>
                  </div>

                  {/* RIGHT: IMAGE WITH PLUS ICON */}
                  <div className="relative w-28 h-24 shrink-0 rounded-xl overflow-hidden border border-gray-100">
                    <img
                      src={item.image}
                      alt={item.name}
                    ...
                    {/* HOVER OVERLAY RED PLUS */}
                    <div className="absolute inset-0 bg-black/10 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                      <div className="bg-[#ff4d24] text-white p-1.5 rounded-lg shadow-lg transform translate-y-2 group-hover:translate-y-0 transition-transform">
                        <Plus size={20} strokeWidth={3} />
                      </div>
                    </div>

                    {/* STATIC SMALL PLUS BUTTON */}
                    <div className="absolute bottom-1 right-1 bg-white text-[#ff4d24] p-0.5 rounded shadow-sm border border-gray-100">
          ...
          <div className="flex justify-center items-center gap-3 mt-16">
            <button className="w-12 h-12 rounded-lg bg-[#ff4d24] text-white font-bold shadow-md">
              01
            </button>
            <button className="w-12 h-12 rounded-lg bg-white border border-gray-200 text-gray-700 font-bold hover:bg-[#ff4d24] hover:text-white transition-all">
              02
            </button>
            <button className="w-12 h-12 rounded-lg bg-white border border-gray-200 text-gray-700 flex items-center justify-center hover:bg-[#ff4d24] hover:text-white transition-all">
