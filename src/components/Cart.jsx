      ...
      <section className="relative w-full h-[450px] md:h-[550px] text-white overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 w-full">
          ...
          >
            ...
            <span className="text-xl">›</span>
            <span className="opacity-80">Cart Page</span>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#F9F9F9]">
        <div className="container mx-auto px-4 md:px-10">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            {/* LEFT: CART TABLE */}
            <div className="flex-2 w-full bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse min-w-[600px]">
                  <thead>
                    <tr className="bg-white border-b border-gray-100">
                      <th className="p-6 font-bold uppercase text-xs tracking-wider text-gray-500">
                        Item
                      </th>
                      <th className="p-6 font-bold uppercase text-xs tracking-wider text-gray-500 text-center">
                        Price
                      </th>
                      <th className="p-6 font-bold uppercase text-xs tracking-wider text-gray-500 text-center">
                        Quantity
                      ...
                      <th className="p-6 font-bold uppercase text-xs tracking-wider text-gray-500 text-right">
                        Remove
                      </th>
                    </tr>
                  </thead>
                      ...
                      >
                        <td className="p-6">
                          <div className="flex items-center gap-4">
                            ...
                            <div className="w-20 h-20 shrink-0 bg-[#F3F4F6] rounded-xl overflow-hidden border border-gray-100">
                              <img
                                src={item.image}
                                alt={item.name}
                        ...
                        <td className="p-6 text-center font-bold text-[#ff4d00] text-lg">
                        ...
                        <td className="p-6">
                          <div className="flex items-center justify-center border border-gray-200 rounded-lg w-fit mx-auto bg-white overflow-hidden">
                            <button
                              ...
                              className="px-4 py-2 hover:bg-gray-100 transition-colors border-r border-gray-200"
                            >
                            ...
                            <button
                              onClick={() => updateQuantity(item.id, 1)}
                              className="px-4 py-2 hover:bg-gray-100 transition-colors border-l border-gray-200"
                            >
              ...
              <div className="p-6 bg-gray-50/30 flex justify-between items-center border-t border-gray-100">
                <button className="text-sm font-black uppercase text-gray-900 hover:text-[#ff4d00] transition-colors">
                  Back to Shop
                </button>
                <button className="bg-[#ff4d00] text-white px-8 py-3 rounded-lg text-sm font-black uppercase hover:bg-black transition-all shadow-md">
                  Update Order
                </button>
              </div>
            </div>
            ...
            <div className="w-full lg:w-[380px] space-y-6">
              <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
                <h4 className="font-black text-xl mb-6 text-gray-900 uppercase tracking-tight">
                  Coupon Code
                </h4>
                <div className="space-y-4">
                  <input
                    ...
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-5 py-4 text-sm focus:outline-none focus:border-[#ff4d00] transition-all"
                  />
                  <button className="w-full border-2 border-[#ff4d00] text-[#ff4d00] hover:bg-[#ff4d00] hover:text-white py-4 rounded-xl font-black text-sm uppercase transition-all tracking-wider">
                    Apply Your Coupon
                  </button>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
                <h4 className="font-black text-xl mb-6 text-gray-900 pb-2 border-b border-gray-100 uppercase tracking-tight">
                  Order Summary
                </h4>
                <div className="space-y-4 text-sm">
                  ...
                  <div className="pt-4 border-t border-gray-100 flex justify-between items-center">
                    ...
                    <span className="font-black text-[#ff4d00] text-2xl">
                      ${total.toFixed(2)}
                    </span>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-100">
                  <h5 className="font-black text-sm text-gray-900 uppercase tracking-wider mb-4">
                    Payment Method
                  </h5>
                  <div className="flex flex-wrap gap-2">
                    {[...Array(5)].map((_, index) => (
                      <div
                        key={index}
                        className="w-12 h-10 border border-gray-200 rounded-md flex items-center justify-center p-1 hover:border-[#ff4d00] transition-colors cursor-pointer bg-white"
                      >
                        <img
                          src={Payment}
                          alt="Payment Method"
                ...
                <button className="w-full bg-[#ff4d00] hover:bg-black text-white py-5 rounded-xl font-black uppercase mt-8 transition-all shadow-lg shadow-orange-100 tracking-widest">
                  Proceed To Checkout
                </button>
              </div>
            </div>
