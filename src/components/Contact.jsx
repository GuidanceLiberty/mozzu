    ...
    <main className="w-full overflow-x-hidden">
      ...
      <section className="relative w-full h-[450px] md:h-[550px] text-white overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 w-full">
          ...
          >
            ...
            <span className="text-xl">›</span>
            <span className="opacity-80">Contact page</span>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative py-24 bg-white overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute left-0 top-1/3 opacity-100 pointer-events-none z-0"
        >
          <img
            src={ShaeLeft}
            alt="decoration"
        ...
        <motion.div
          ...
          className="absolute right-0 bottom-20 opacity-100 pointer-events-none z-0"
        >
          <img
            src={ShaeRight}
            alt="decoration"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-5">
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="bg-[#ff4d00] text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-[#e64500] transition-all flex items-center gap-2 group shadow-lg active:scale-95"
                >
                  Send Us Message
            ...
            <div className="lg:col-span-7 space-y-6">
              {offices.map((office) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-[#fff0e6] rounded-[25px] overflow-hidden flex flex-col md:flex-row items-center gap-6 p-2 shadow-sm border border-orange-50"
                >
                  {/* Office Image */}
                  <div className="w-full md:w-1/3 h-48 md:h-full overflow-hidden rounded-[20px]">
                    <img
                      src={office.image}
                      alt={office.title}
                  ...
                  <div className="w-full md:w-2/3 p-4 md:pr-8">
                    ...
                    <div className="flex flex-col gap-3">
                      <button className="text-[#ff4d00] font-bold text-sm underline text-left hover:text-[#e64500]">
                        View on map
                      </button>
                      <a
                        href={`tel:${office.phone}`}
                        className="flex items-center gap-2 text-[#0a0a0a] font-bold hover:text-[#ff4d00] transition-colors"
                      >
                        <Phone className="text-[#ff4d00]" size={18} />
                        {office.phone}
                      </a>
                    </div>
                  </div>
