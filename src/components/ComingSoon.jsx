...
import OopsImg from "@/assets/img/logo/oops.png";
      ...
      <section className="w-full bg-white py-20 md:py-32 px-4 overflow-hidden">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
          ...
          <motion.p
            ...
            className="text-gray-600 text-base md:text-lg leading-relaxed max-w-2xl mb-12"
          >
          ...
          >
            <Button
              variant="mozzu"
              className="px-10 py-4 bg-[#ff4d00] hover:bg-[#e64500] text-white rounded-lg text-sm font-bold uppercase tracking-widest transition-all duration-300 shadow-lg shadow-orange-200"
            >
              Previews Page
            </Button>
          </motion.div>
