    ...
    <main className="w-full overflow-x-hidden">
      ...
      <section className="relative w-full h-[450px] md:h-[550px] text-white overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 w-full">
          ...
          >
            ...
            <span className="text-xl">›</span>
            <span className="opacity-80">Menu Categories</span>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white overflow-hidden">
        <div className="max-w-[1380px] mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="relative group overflow-hidden flex items-center gap-2 font-bold text-orange-500 border-2 border-orange-400 px-7 py-3 rounded-xl transition-colors duration-500 hover:text-white active:text-white shadow-sm"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-7">
            {visitedRestaurant.map((res, index) => (
              <motion.div
                ...
                whileHover={{ y: -10 }}
                className="flex flex-col group bg-white border border-gray-300 rounded-md overflow-hidden transition-all duration-300 hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)]"
              >
                {/* IMAGE CONTAINER */}
        ...
        <div className="relative w-full bg-white py-24 px-4 overflow-hidden">
          ...
          <motion.img
            src={menuCategories[14].bigLeftSideImg}
            alt="decoration"
            className="absolute left-0 bottom-0 w-32 md:w-48 lg:w-64 pointer-events-none opacity-80 z-0"
            animate={{ y: [0, -20, 0] }}
            transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
          />

          <motion.img
            src={menuCategories[14].bigRightSideImg}
            alt="decoration"
            className="absolute right-0 top-[40%] w-32 md:w-48 lg:w-64 pointer-events-none opacity-80 z-0"
            animate={{ y: [0, 30, 0] }}
            transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
          />

          <div className="relative z-10 max-w-[1400px] mx-auto space-y-24">
            {/* ARRAY OF BLOCKS TO KEEP CODE CLEAN */}
            {[
              {
                title: menuCategories[0].heading1,
                items: menuCategories.slice(1, 5),
              },
              {
                title: menuCategories[5].heading2,
                items: menuCategories.slice(6, 9),
              },
              {
                title: menuCategories[9].heading3,
                items: menuCategories.slice(10, 14),
              },
            ].map((block, bIdx) => (
              <div key={bIdx} className="flex flex-col">
                {/* RESPONSIVE HEADER: Column on mobile, Row on Desktop */}
                <div className="mb-12 flex flex-col md:flex-row md:justify-between md:items-end border-b border-gray-100 pb-8 gap-6">
                  <div className="relative">
                    <h2 className="text-[32px] md:text-[40px] font-extrabold text-[#1a1a1a] leading-tight">
                      {block.title}
                    </h2>
                    <motion.div
                      initial={{ width: 0 }}
                      ...
                      transition={{ delay: 0.5, duration: 0.8 }}
                      viewport={{ once: true }}
                      className="absolute -bottom-3 left-0 h-1.5 bg-[#ff0000] rounded-full"
                    />
                  </div>
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="relative group overflow-hidden flex items-center justify-center gap-2 font-bold text-orange-500 border-2 border-orange-400 px-7 py-3 rounded-xl transition-colors duration-500 hover:text-white w-fit shadow-sm"
                  >
                    <span className="relative z-10">Show More</span>
                    <ArrowRight
                      size={20}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {block.items.map((item, idx) => (
                    <motion.div
                      ...
                      whileInView={{ opacity: 1, y: 0 }}
                      viewport={{ once: true }}
                      className="group flex p-6 bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300"
                    >
                      ...
                      <div className="relative w-24 h-24 shrink-0 rounded-xl overflow-hidden ml-4">
                        <img
                          src={item.image}
