...
import { restaurantDetail } from "@/data/restaurantDetail01";
import { visitedRestaurant } from "@/data/home4Data";

const RestaurantDetail01 = () => {
  return (
    <main className="w-full overflow-x-hidden">
      ...
      <section className="relative w-full h-[450px] md:h-[550px] text-white overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 w-full">
          ...
          >
            ...
            <span className="text-xl">›</span>
            <span className="opacity-80">Restaurant Details</span>
          </motion.div>
        </div>
      </section>

      {/* ================= RESTAURANT DETAILS 01 SECTION ================= */}
      <section className="py-10 md:py-20 bg-white relative">
        {/* LEFT FLOATING IMAGE - bottom left */}
        <motion.img
          src={restaurantDetail.shaeLeft}
          alt="decoration-left"
          className="absolute left-0 bottom-0 w-32 pointer-events-none z-0"
          animate={{ y: [0, -15, 0] }}
          transition={{
            duration: 4,
            repeat: Infinity,
        ...
        <div className="container mx-auto px-4 max-w-[1400px] relative z-10">
          <div className="relative group">
            {/* Main Hero Image - Rounded class moved here */}
            <img
              src={restaurantDetail.mainHero}
              alt={restaurantDetail.name}
              className="w-full h-[500px] md:h-[600px] object-cover rounded-[40px]"
            />

            {/* Info Overlay Card - Overlapping the image */}
            <motion.div
              initial={{ opacity: 0, x: -30 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="absolute left-6 -bottom-10 md:left-10 md:-bottom-16 bg-white p-6 md:p-10 rounded-[30px] shadow-2xl max-w-[90%] md:max-w-[450px] z-20"
            >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-1 bg-[#FFF9E5] px-3 py-1 rounded-full">
                  <Star className="text-[#FFC107] fill-[#FFC107]" size={16} />
                  <span className="font-black text-black">
                    {restaurantDetail.rating} ({restaurantDetail.reviews})
                  </span>
                </div>
              </div>

              <div className="flex items-center gap-2 text-gray-700 font-bold mb-6">
                <MapPin className="text-[#ff4d00]" size={18} />
                <span>{restaurantDetail.location}</span>
              </div>

              <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                <p className="text-[#ff4d00] font-black text-lg leading-tight">
                  {restaurantDetail.offer}
                </p>
        ...
        <motion.img
          src={restaurantDetail.shaeRight}
          alt="decoration-right"
          className="absolute right-0 top-1/2 -translate-y-1/2 w-48 md:w-64 pointer-events-none z-0"
          animate={{ y: [-10, 10, -10] }}
          transition={{
            duration: 5,
            repeat: Infinity,
        ...
        <div className="py-20 bg-white">
          <div className="container mx-auto px-4 max-w-[1400px]">
            <div className="relative w-full h-[550px] group border border-gray-100">
              {/* REAL GOOGLE MAP EMBED - Grayscale handled by iframe class, rounding moved to style */}
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4056910.1916325996!2d4.469796010777977!3d9.0819990529949!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x104e0baf7da48d0d%3A0x99a8fe4168c50bc8!2sNigeria!5e0!3m2!1sen!2sng!4v1705740000000!5m2!1sen!2sng"
                width="100%"
                height="100%"
                ...
                className="grayscale hover:grayscale-0 shadow-2xl transition-all duration-1000 ease-in-out"
              ></iframe>
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="absolute top-10 left-10 bg-white p-7 rounded-[25px] shadow-[0_20px_50px_rgba(0,0,0,0.2)] z-20 w-[340px] border border-gray-50"
              >
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <a
                      href="https://www.google.com/maps/place/Nigeria/"
                      target="_blank"
                      rel="noreferrer"
                      className="text-[#4285F4] text-sm font-bold hover:underline"
                    >
                      View larger map
                    </a>
                  </div>
                  ...
                  <div className="flex flex-col items-center group/btn cursor-pointer">
                    <div className="w-14 h-14 bg-gray-50 rounded-full flex items-center justify-center text-[#4285F4] mb-1 group-hover/btn:bg-[#4285F4] group-hover/btn:text-white transition-all duration-300">
                      <Compass size={28} />
                    </div>
      ...
      {/* ================= FOOTER SECTION ================= */}
      <footer className="relative bg-[#0a0a0a] text-white pt-32 pb-10">
        ...
        <div className="max-w-[1400px] mx-auto px-6 relative z-10">
          {/* PROFESSIONAL OVERLAPPING CARD */}
          <motion.div
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="relative -mt-48 mb-28 bg-[#ff4d00] rounded-[50px] p-12 md:p-20 shadow-2xl overflow-hidden z-30"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 relative z-10">
              ...
              <div className="md:border-r border-white/20 pr-8">
                <h3 className="text-4xl md:text-5xl font-black mb-10 tracking-tight">
                  Opening hours
                </h3>
                <ul className="space-y-4 text-lg md:text-xl font-bold">
                  <li className="flex justify-between border-b border-white/10 pb-2">
                    <span>Monday - Friday :</span> <span>9.00am - 22.00pm</span>
                  </li>
                  <li className="flex justify-between border-b border-white/10 pb-2">
                    <span>Saturday :</span> <span>9.00am - 22.00pm</span>
                  </li>
                  <li className="flex justify-between border-b border-white/10 pb-2">
                    <span>Sunday :</span> <span>5.00pm - 23.00pm</span>
                  </li>
                  <li className="pt-4 flex justify-between text-white/90">
                    <span>Happy Hour :</span> <span>15.00pm - 20.00pm</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="md:pl-10">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-4 text-lg md:text-xl font-bold">
          ...
          <div className="flex items-center justify-center mb-24">
            ...
            >
              <img src={Logo} alt="Mozzo" className="h-14 w-auto mb-2" />
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
              ...
              >
                ...
                <ul className="space-y-5 text-gray-400 font-medium">
                  {col.links.map((link) => (
                    <li
                      key={link}
                      className="hover:text-[#ff4d00] cursor-pointer transition-colors duration-300"
                    >
                      {link}
                    </li>
                  ))}
            ...
            >
              ...
              <div className="space-y-6 text-gray-400 font-medium">
                ...
                <p className="hover:text-[#ff4d00] cursor-pointer transition-colors text-lg">
                  info@gmail.com
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative border-b-2 border-white/20 pb-4 group">
                ...
                />
                <button className="absolute right-0 top-0 text-white group-hover:text-[#ff4d00] transition-colors">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
          ...
          >
            <p className="text-gray-500 font-medium">
              Copyright © 2025 <span className="text-[#ff4d00]">Mozzo</span> all
              Right Reserved
            </p>
...
export default RestaurantDetail01;
