      ...
      <section className="relative w-full h-[450px] md:h-[550px] text-white overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 w-full">
          ...
          >
            ...
            <span className="text-xl">›</span>
            <span className="opacity-80">Restaurant list</span>
          </motion.div>
        </div>
      </section>

      {/* ================= RESTAURANT LIST ================= */}
      <section className="relative w-full bg-[#f9f9f9] py-24 px-4 overflow-hidden">
        {/* FLOATING DECORATIVE IMAGES */}
        <motion.img
          src={restaurantList[9].floatingleftImg}
          alt="decoration"
          className="absolute -left-10 bottom-10 w-48 lg:w-80 pointer-events-none opacity-90 z-0"
          animate={{ y: [0, -30, 0] }}
          transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.img
          src={restaurantList[9].floatingrightImg}
          alt="decoration"
          className="absolute -right-10 top-[10%] w-48 lg:w-80 pointer-events-none opacity-90 z-0"
          animate={{ y: [0, 35, 0] }}
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {restaurantList.slice(0, 9).map((item, idx) => (
              <motion.div
                key={idx}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="bg-[#FFF9F1] rounded-md overflow-hidden border border-[#F3E8D9] group hover:shadow-md transition-all duration-500"
              >
                {/* IMAGE SECTION */}
                <div className="relative h-[280px] w-full overflow-hidden">
                  ...
                  <div className="absolute top-5 left-5 flex gap-2">
                    <span className="bg-[#ff4d24] text-white text-[11px] font-black uppercase tracking-wider px-4 py-1.5 rounded-full shadow-lg">
                      Flat 15% Off
                    </span>
                    <span className="bg-[#ff8a00] text-white text-[11px] font-black uppercase tracking-wider px-4 py-1.5 rounded-full shadow-lg">
                      Featured
                    </span>
                  </div>

                  {/* HOVER OVERLAY: Name revealed on hover */}
                  <div className="absolute inset-0 bg-black/40 backdrop-blur-[2px] flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                    <h3 className="text-white text-3xl font-bold px-8 text-center leading-tight transform translate-y-6 group-hover:translate-y-0 transition-transform duration-500">
                      {item.name}
                    </h3>
                  </div>
                </div>
                ...
                <div className="p-8">
                  <div className="flex justify-between items-center mb-5">
                    <div className="flex items-center gap-2 text-gray-500 text-sm font-semibold">
                      <span className="w-2 h-2 rounded-full bg-[#ff4d24]"></span>
                      {item.title}
                    </div>
                  ...
                  <div className="flex justify-between items-center mb-5">
                    <div className="flex items-center gap-2 font-bold text-xl text-[#1a1a1a]">
                      <MapPin size={20} className="text-[#ff4d24]" />
                      {item.location}
                    </div>
                  ...
                  <p className="text-[#ff4d24] font-extrabold text-lg mb-8 leading-snug">
                    {item.description}
                  </p>

                  {/* BOTTOM BAR */}
                  <div className="pt-6 border-t border-[#EEDFCB] flex justify-between items-center">
                    <div className="flex items-center gap-2 text-gray-600 font-bold">
                      <Clock size={20} className="text-[#ff4d24]" />
                      {item.time}
                    </div>
                    <Link
                      to={`/restaurant/${idx}`}
                      className="flex items-center gap-1 text-[#1a1a1a] font-black hover:text-[#ff4d24] transition-all group/link"
                    >
                      View More
                      <ChevronRight
                        size={20}
          ...
          <div className="flex justify-center items-center gap-3 mt-20">
            <button className="w-12 h-12 rounded-xl bg-[#E6EBF1] flex items-center justify-center text-gray-600 hover:bg-[#ff4d24] hover:text-white transition-all">
              <ChevronLeft size={24} />
            </button>
            <button className="w-12 h-12 rounded-xl bg-[#ff4d24] text-white font-black text-lg shadow-xl shadow-orange-200">
              01
            </button>
            <button className="w-12 h-12 rounded-xl bg-white border border-gray-200 text-gray-600 font-bold hover:bg-[#ff4d24] hover:text-white transition-all">
              02
            </button>
            <button className="w-12 h-12 rounded-xl bg-white border border-gray-200 text-gray-600 font-bold hover:bg-[#ff4d24] hover:text-white transition-all">
              03
