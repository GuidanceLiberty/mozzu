          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-8 space-y-5">
              {faqs.map((faq) => (
                <div
                  key={faq.id}
                  className={`rounded-[25px] border-2 transition-all duration-300 ${
                    activeId === faq.id
                      ? "border-[#ff4d00] bg-white shadow-xl shadow-orange-100/20"
                ...
                >
                  ...
                  >
                    <span
                      className={`text-lg md:text-2xl font-black transition-colors ${
                        activeId === faq.id
                          ? "text-[#ff4d00]"
                          : "text-black group-hover:text-[#ff4d00]"
                      }`}
                    >
                      {faq.question}
                    </span>
                  ...
                  <AnimatePresence>
                    {activeId === faq.id && (
                      ...
                      >
                        <div className="px-6 md:px-8 pb-8 pt-0 text-gray-600 text-lg leading-relaxed font-medium">
                          {faq.answer}
                        </div>
                      </motion.div>
                    )}
            ...
            {/* RIGHT: GET FREE QUOTE SIDEBAR */}
            <aside className="lg:col-span-4 sticky top-[120px]">
              <div className="bg-white border-2 border-orange-500 rounded-[40px] p-8 md:p-10 shadow-2xl shadow-gray-200/50 relative overflow-hidden">
                {/* Visual Decoration */}
                <div className="absolute -right-10 -top-10 opacity-10 pointer-events-none">
                  <Sparkles size={150} className="text-[#ff4d00]" />
                </div>

                <h3 className="text-3xl md:text-4xl font-black text-black mb-8 relative z-10">
                  Get Free Quote
                </h3>
                ...
                >
                  <div className="space-y-2">
                    <input
                      ...
                      className="w-full bg-[#F8F8F8] rounded-2xl p-5 text-gray-700 font-bold focus:outline-none focus:ring-2 focus:ring-[#ff4d00]/50 transition-all border border-transparent"
                    />
                  </div>
                  <div className="space-y-2">
                    <input
                  ...
                  <div className="space-y-2">
                    <textarea
                      placeholder="Message"
                      className="w-full bg-[#F8F8F8] rounded-3xl p-6 h-40 text-gray-700 font-bold focus:outline-none focus:ring-2 focus:ring-[#ff4d00]/50 transition-all border border-transparent resize-none"
                    ></textarea>
                  </div>

                  <Button className="w-full bg-[#ff4d00] hover:bg-black text-white font-black py-8 rounded-2xl text-lg uppercase tracking-wider transition-all shadow-lg shadow-orange-600/20 group">
                    Get A Quote
                    <ChevronRight
                      size={20}
