...
import Oops from "@/assets/img/logo/oops.png";
...
const Error = () => {
  return (
    <main className="w-full overflow-x-hidden">
      ...
      {/* ================= ERROR SECTION ================= */}
      <section className="relative py-32 bg-white overflow-hidden min-h-[80vh] flex items-center justify-center">
        {/* Floating Background Decorations - Left */}
        <motion.div
        ...
        {/* Floating Background Decorations - Right */}
        <motion.div
          animate={{ y: [0, 20, 0], rotate: [0, -5, 0] }}
          transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
          className="absolute right-0 bottom-1/4 opacity-100 pointer-events-none z-0"
        >
          <img
            src={ShaeRight}
            alt="decoration"
        ...
        <div className="max-w-[800px] mx-auto px-6 text-center relative z-10">
          ...
          >
            <img
              src={Oops}
              alt="Oops!"
              className="mx-auto w-full max-w-[500px] md:max-w-[650px] h-auto object-contain"
            />
          </motion.div>

          {/* Error Title */}
          <h1 className="text-3xl md:text-4xl font-black text-[#0a0a0a] mb-6">
            404 page Not Found
          </h1>

          {/* Error Description */}
          <p className="text-gray-600 text-lg md:text-xl leading-relaxed mb-10 max-w-2xl mx-auto">
            During the execution of the database query, a timeout occurred. This
            issue arose because the system exceeded the maximum allowed response
            time for data retrieval, which is set at 30 seconds.
          </p>

          {/* Return Button */}
          <Link to="/">
            <button className="bg-[#ff4d00] text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-[#e64500] transition-all transform active:scale-95 shadow-lg hover:shadow-[#ff4d00]/30">
              Previews Page
            </button>
          </Link>
        </div>
