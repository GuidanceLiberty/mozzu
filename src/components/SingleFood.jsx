...
import { ourMenu } from "@/data/singleFoodData";
  ...
  return (
    <main className="w-full overflow-x-hidden">
      ...
      <section className="relative w-full h-[450px] md:h-[550px] text-white overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 w-full">
          ...
          >
            ...
            <span className="text-xl">›</span>
            <span className="opacity-80">Single Food Menu</span>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative w-full bg-white py-24 px-4 overflow-hidden">
        ...
        <motion.img
          src={ourMenu[36].leftSideImg}
          alt="decoration"
          className="absolute left-0 top-[10%] w-32 md:w-48 lg:w-64 pointer-events-none opacity-80 z-0"
          animate={{
            y: [0, -20, 0],
          }}
          transition={{
        ...
        <motion.img
          src={ourMenu[36].leftSideImg}
          alt="decoration"
          className="absolute -left-5 bottom-0 w-32 md:w-48 lg:w-64 pointer-events-none opacity-60 z-0"
          animate={{
            y: [0, 25, 0],
            rotate: [0, 5, 0],
          }}
        ...
        {/* FIRST ROW: SPECIAL & REGULAR MENU */}
        <div className="relative z-10 max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-16">
          {/* LEFT SIDE: SPECIAL MENU */}
          <div className="flex flex-col">
            <div className="mb-12">
              <h2 className="text-[40px] font-bold text-[#1a1a1a] mb-4">
                {ourMenu[0].heading1}
              </h2>
              {/* DOUBLE GOLD DIVIDER LINES */}
              <div className="flex flex-col gap-0.5">
                <div className="w-full h-1.5 bg-[#f3e8d5]"></div>
                <div className="w-full h-1.5 bg-[#f3e8d5]"></div>
              </div>
            </div>

            <div className="flex flex-col gap-10">
              {ourMenu.slice(1, 6).map((item, idx) => (
                <motion.div
                  key={idx}
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="flex items-end justify-between border-b border-dotted border-gray-300 pb-1 mb-1">
                      <h4 className="font-bold text-[#1a1a1a] text-3xl leading-wider">
                        {item.name}
                      </h4>
                      <span className="font-bold text-[#d9a34a] text-xl">
                        {item.price}
                      </span>
                    </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-10">
              {ourMenu.slice(7, 12).map((item, idx) => (
                <motion.div
                  key={idx}
                  initial={{ opacity: 0, y: 10 }}
                  whileInView={{ opacity: 1, y: 0 }}
        ...
        {/* SECOND ROW: DESERT & BEVERAGE MENU */}
        <div className="relative z-10 max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-16 mt-24">
          {/* LEFT SIDE: DESERT MENU (Heading 3) */}
          <div className="flex flex-col">
            <div className="mb-12">
              <h2 className="text-[40px] font-bold text-[#1a1a1a] mb-4">
                {ourMenu[12].heading3}
            ...
            <div className="flex flex-col gap-10">
              {ourMenu.slice(13, 18).map((item, idx) => (
                <motion.div
                  key={idx}
                  initial={{ opacity: 0, y: 10 }}
                  whileInView={{ opacity: 1, y: 0 }}
          ...
          {/* RIGHT SIDE: BEVERAGE MENU (Heading 4) */}
          <div className="flex flex-col">
            <div className="mb-12">
              <h2 className="text-[40px] font-bold text-[#1a1a1a] mb-4">
                {ourMenu[18].heading4}
            ...
            <div className="flex flex-col gap-10">
              {ourMenu.slice(19, 24).map((item, idx) => (
                <motion.div
                  key={idx}
                  initial={{ opacity: 0, y: 10 }}
                  whileInView={{ opacity: 1, y: 0 }}
        ...
        {/* THIRD ROW: FAST FOOD & CHINESE MENU */}
        <div className="relative z-10 max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-16 mt-24">
          {/* LEFT SIDE: FAST FOOD MENU (Heading 5) */}
          <div className="flex flex-col">
            <div className="mb-12">
              <h2 className="text-[40px] font-bold text-[#1a1a1a] mb-4">
                {ourMenu[24].heading5}
            ...
            <div className="flex flex-col gap-10">
              {ourMenu.slice(25, 30).map((item, idx) => (
                <motion.div
                  key={idx}
                  initial={{ opacity: 0, y: 10 }}
                  whileInView={{ opacity: 1, y: 0 }}
          ...
          {/* RIGHT SIDE: CHINESE MENU (Heading 6) */}
          <div className="flex flex-col">
            <div className="mb-12">
              <h2 className="text-[40px] font-bold text-[#1a1a1a] mb-4">
                {ourMenu[30].heading6}
            ...
            <div className="flex flex-col gap-10">
              {ourMenu.slice(31, 36).map((item, idx) => (
                <motion.div
                  key={idx}
                  initial={{ opacity: 0, y: 10 }}
                  whileInView={{ opacity: 1, y: 0 }}
